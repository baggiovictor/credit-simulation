...
import static com.baggiovictor.creditsimulation.domain.creditsimulation.strategy.credit.CreditSimulationStrategyFactory.getCreditStrategy;
import static com.baggiovictor.creditsimulation.domain.creditsimulation.strategy.rate.InterestRateFactory.getRateStrategy;
...
public class CreditSimulation {
  ...
  public void validate(final ValidationHandler handler) {
    new CreditSimulationValidator(this, handler).validate();
  }
}
